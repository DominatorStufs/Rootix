...
//                }
                ...
                RootixLocationManager l = RootixLocationManager.instance(mContext);
...
//                    if(suggestionsManager != null) suggestionsManager.clear();
                    ...
                    if(intent.getBooleanExtra(RootixLocationManager.FAIL, false)) {
                        ...
                        lastLatitude = intent.getDoubleExtra(RootixLocationManager.LATITUDE, 0);
                        lastLongitude = intent.getDoubleExtra(RootixLocationManager.LONGITUDE, 0);
