package ohi.andre.consolelauncher.commands.rootixt.raw;

import ohi.andre.consolelauncher.R;
import ohi.andre.consolelauncher.commands.CommandAbstraction;
import ohi.andre.consolelauncher.commands.ExecutePack;
import ohi.andre.consolelauncher.commands.rootixt.RootixtPack;
...
public class save implements CommandAbstraction {
    ...
    public String exec(ExecutePack info) throws Exception {
        ...
        if(error == null) {
            return pack.resources.getString(R.string.rootixt_saved);
        } else {
            return error;
        }
    }
    ...
    @Override
    public int helpRes() {
        return R.string.help_rootixt_save;
    }
