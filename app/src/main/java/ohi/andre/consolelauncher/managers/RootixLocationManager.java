...
public class RootixLocationManager {
    ...
    private static RootixLocationManager instance;
    public static RootixLocationManager instance(Context context) {
        if(instance == null) instance = new RootixLocationManager(context);
        return instance;
    }

    private RootixLocationManager(final Context context) {
