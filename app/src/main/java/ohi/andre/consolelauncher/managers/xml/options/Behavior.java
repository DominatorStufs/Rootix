...
public enum Behavior implements XMLPrefsSave {
    ...
    double_tap_lock {
        ...
        @Override
        public String info() {
            return "If true, rootix will lock the screen on double tap";
        }
    ...
    songs_from_mediastore {
        ...
        @Override
        public String info() {
            return "If true, rootix will get tracks from the system mediastore";
        }
    ...
    rootix_notification {
        ...
        @Override
        public String info() {
            return "If true, there will always be a notification in your status bar, telling you that rootix is running";
        }
    ...
    auto_show_keyboard {
        ...
        @Override
        public String info() {
            return "If true, your keyboard will be shown everytime you go back to rootix";
        }
    ...
    show_hints {
        ...
        @Override
        public String info() {
            return "If true, rootix will tell you some useful hints sometime";
        }
    ...
    show_launch_history {
        ...
        @Override
        public String info() {
            return "If false, rootix won't show the apps that you launch";
        }
    ...
    enable_app_launch {
        ...
        @Override
        public String info() {
            return "If false, you won't be able to launch apps from rootix, unless you use \"apps -frc\"";
        }
    ...
    alias_replace_all_markers {
        ...
        @Override
        public String info() {
            return "If true, if you pass a lower number of parameters to an alias, rootix will use the first one to replace the others";
        }
    ...
    enable_music {
        ...
        @Override
        public String info() {
            return "If true, you will be able to use rootix as a music player. Otherwise, the music command will try to communicate with the music player that your using";
        }
    ...
    max_optional_depth {
        ...
        @Override
        public String info() {
            return "A value which is used to tell how deep rootix can go in a nested optional value";
        }
    ...
    rootix_notification_title {
        ...
        @Override
        public String info() {
            return "The title of the Rootix notification";
        }
    ...
    rootix_notification_subtitle {
        @Override
        public String defaultValue() {
            return "Rootix is running";
        }

        @Override
        public String info() {
            return "The subtitle of the Rootix notification";
        }
    ...
    rootix_notification_click_cmd {
        ...
        @Override
        public String info() {
            return "The command ran when the Rootix notification is clicked";
        }
    ...
    rootix_notification_click_showhome {
        @Override
        public String defaultValue() {
            return "true";
        }
        ...
        @Override
        public String info() {
            return "If false, the click on the Rootix notification won't bring you to your phone home";
        }
    ...
    rootix_notification_lastcmds_size {
        @Override
        public String defaultValue() {
            return "5";
        }
        ...
        @Override
        public String info() {
            return "The number of used commands that will appear inside the Rootix notification (<0 will disable the feature)";
        }
    ...
    rootix_notification_lastcmds_updown {
        @Override
        public String defaultValue() {
            return "true";
        }
    ...
    rootix_notification_priority {
        ...
        @Override
        public String info() {
            return "The priority of the Rootix notification (min: -2, max: 2)";
        }
    ...
    append_quote_before_file {
        ...
        @Override
        public String info() {
            return "If true, rootix will automatically append a quote before a file inserted clicking on a suggestion";
        }
    ...
    rootix_notification_time_color {
        @Override
        public String defaultValue() {
        ...
        @Override
        public String info() {
            return "The time color inside the rootix notification";
        }
    ...
    rootix_notification_input_color {
        @Override
        public String defaultValue() {
        ...
        @Override
        public String info() {
            return "The input color inside the rootix notification";
        }
    ...
    clear_on_lock {
        ...
        @Override
        public String info() {
            return "If true, rootix will clear the screen when you lock the phone";
        }
    ...
    show_weather_updates {
        ...
        @Override
        public String info() {
            return "If false, rootix won't show information about the weather in the output field";
        }
