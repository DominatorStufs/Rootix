...
import com.rootix.launcher.commands.rootixt.RootixtActivity;
import com.rootix.launcher.managers.ContactManager;
import com.rootix.launcher.managers.RegexManager;
...
import com.rootix.launcher.managers.notifications.NotificationManager;
import com.rootix.launcher.managers.notifications.NotificationMonitorService;
import com.rootix.launcher.managers.notifications.NotificationService;
import com.rootix.launcher.managers.suggestions.SuggestionsManager;
import com.rootix.launcher.managers.xml.XMLPrefsManager;
import com.rootix.launcher.managers.xml.options.Behavior;
import com.rootix.launcher.managers.xml.options.Notifications;
import com.rootix.launcher.managers.xml.options.Theme;
import com.rootix.launcher.managers.xml.options.Ui;
import com.rootix.launcher.tuils.Assist;
import com.rootix.launcher.tuils.BusyBoxInstaller;
import com.rootix.launcher.tuils.CustomExceptionHandler;
import com.rootix.launcher.tuils.LongClickableSpan;
import com.rootix.launcher.tuils.PrivateIOReceiver;
import com.rootix.launcher.tuils.PublicIOReceiver;
import com.rootix.launcher.tuils.SimpleMutableEntry;
import com.rootix.launcher.tuils.Tuils;
import com.rootix.launcher.tuils.interfaces.Inputable;
import com.rootix.launcher.tuils.interfaces.Outputable;
...
public class LauncherActivity extends AppCompatActivity implements Reloadable {
    ...
    public static final int ROOTIXT_REQUEST = 10;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            if (!android.os.Environment.isExternalStorageManager()) {
                ...
                Toast.makeText(this, "Please grant storage permissions to Rootix", Toast.LENGTH_LONG).show();
            }
        }
    ...
    private void finishOnCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            getApplicationContext().registerReceiver(publicIOReceiver, filter1, "com.rootix.launcher.permission.RECEIVE_CMD", null, Context.RECEIVER_EXPORTED);
        } else {
            getApplicationContext().registerReceiver(publicIOReceiver, filter1, "com.rootix.launcher.permission.RECEIVE_CMD", null);
        }
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == ROOTIXT_REQUEST && resultCode != 0) {
            if(resultCode == RootixtActivity.BACK_PRESSED) {
                Tuils.sendOutput(this, R.string.rootixt_back_pressed);
            } else {
                Tuils.sendOutput(this, data.getStringExtra(RootixtActivity.ERROR_KEY));
            }
        }
    }
