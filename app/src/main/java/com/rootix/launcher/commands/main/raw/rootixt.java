...
import com.rootix.launcher.LauncherActivity;
...
public class rootixt implements CommandAbstraction {
    ...
    public String exec(ExecutePack pack) {
        ...
        Intent intent = new Intent(info.context, RootixtActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(RootixtActivity.PATH, file.getAbsolutePath());
        ((Activity) info.context).startActivityForResult(intent, LauncherActivity.ROOTIXT_REQUEST);
    ...
    public String onNotArgEnough(ExecutePack pack, int nArgs) {
        MainPack info = (MainPack) pack;
        return info.res.getString(R.string.help_rootixt);
    }
}
