...
public class rootix extends ParamCommand {
    ...
    private enum Param implements com.rootix.launcher.commands.main.Param {
        ...
        log {
            ...
            public String onNotArgEnough(ExecutePack pack, int n) {
                return pack.context.getString(R.string.help_rootix);
            }
        },
        priority {
            @Override
        ...
        sourcecode {
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://github.com/DominatorStufs/Rootix"));
                return null;
            }
        },
        reset {
