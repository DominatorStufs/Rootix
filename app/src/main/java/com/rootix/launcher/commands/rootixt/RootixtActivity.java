...
public class RootixtActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CommandGroup group = new CommandGroup(this, "com.rootix.launcher.commands.rootixt.raw");
        ...
        int layoutId = inputBottom ? R.layout.rootixt_view_input_down : R.layout.rootixt_view_input_up;
...
//        end setup part, now start
        ...
        pack = new RootixtPack(group, file, this, fileView);

        fileView.setText(getString(R.string.rootixt_reading) + Tuils.SPACE + path);
        new StoppableThread() {
                ...
                try {
                    ...
                    runOnUiThread(() -> {
                        try {
                            ...
                            Toast.makeText(RootixtActivity.this, R.string.rootixt_error, Toast.LENGTH_LONG).show();
                        }
                    });
                } catch (Exception e) {
                    Log.e("andre", "", e);
