...
import static com.rootix.launcher.UIManager.PREFS_NAME;
...
//                    is font
        ...
        tutorial {
            ...
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://github.com/DominatorStufs/Rootix/wiki/Customize-T_UI"));
                return null;
            }
        };
    ...
    @Override
    protected com.rootix.launcher.commands.main.Param paramForString(MainPack pack, String param) {
