...
import com.rootix.launcher.commands.main.specific.APICommand;
...
public class notifications extends ParamCommand implements APICommand {
    ...
    private enum Param implements com.rootix.launcher.commands.main.Param {
        ...
        tutorial {
            ...
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://github.com/DominatorStufs/Rootix/wiki/Notifications"));
                return null;
            }
        };
