...
public enum Suggestions implements XMLPrefsSave {
    ...
    double_space_click_first_suggestion {
        ...
        @Override
        public String info() {
            return "If true, rootix will simulate a click on the current first suggestion if you double-click the space bar";
        }
    },
    ...
    suggestions_quickcompare_n {
        ...
        @Override
        public String info() {
            return "If the input is shorter than n characters, rootix will try to show you the entries which start with those characters";
        }
    },
