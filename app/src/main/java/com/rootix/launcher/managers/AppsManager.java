...
import static com.rootix.launcher.managers.xml.XMLPrefsManager.resetFile;
...
//                todo support delete
                ...
                Tuils.sendOutput(Color.RED, context, R.string.rootixnotfound_app);
            }
...
//                    rootix is not the default launcher
                    Tuils.log(e);
                }
...
//    }
    ...
    public String printAllInstalledApps() {
        ...
        for (ApplicationInfo info : installed) {
            ...
            labels.add(label + " (" + info.packageName + ")");
        }
