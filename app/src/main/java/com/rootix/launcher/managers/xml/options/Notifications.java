...
public enum Notifications implements XMLPrefsSave {
    ...
    show_notifications {
        ...
        @Override
        public String info() {
            return "If true, rootix will show every incoming notification";
        }
    },
    app_notification_enabled_default {
        ...
        @Override
        public String info() {
            return "If true, rootix will show notifications from all apps, unless they are explicitly excluded. If false, rootix won't show a notification from a specific app unless it was \texplicitly included";
        }
    },
    ...
    click_notification {
        ...
        @Override
        public String info() {
            return "If true, Rootix will perform the operation associated with the original notification when you click it";
        }
    },
